...
RSpec.describe "ledger_projection (stateful scaffold)" do
  ...
  class PostCreditCommand
    ...
    def verify!(before_state:, after_state:, args:, result:, sut:)
      ...
      # Analyzer hints: state_field="entries", size_delta=1, transition_kind=:append, requires_non_empty_state=false, scalar_update_kind=nil, command_confidence=:high, guard_kind=:none, guard_field="entries", guard_constant=nil, rhs_source_kind=:arg, state_update_shape=:append_like
