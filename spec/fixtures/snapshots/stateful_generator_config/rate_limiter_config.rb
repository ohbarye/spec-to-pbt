...
RateLimiterPbtConfig = {
  ...
  verify_context: {
    state_reader: nil, # suggested: ->(sut) { { remaining: sut.remaining, capacity: sut.capacity } }; configure this when observed-state checks should be compared against the model
  }
  # before_run: ->(sut) { },
