...
RSpec.describe "wallet_with_limit (stateful scaffold)" do
  ...
  class DepositCommand
    ...
    def verify!(before_state:, after_state:, args:, result:, sut:)
      ...
      # Analyzer hints: state_field="balance", size_delta=1, transition_kind=nil, requires_non_empty_state=false, scalar_update_kind=:increment_like, command_confidence=:high, guard_kind=:none, rhs_source_kind=:unknown, state_update_shape=:increment
