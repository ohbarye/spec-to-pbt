...
- Date: 2026-03-17
- Scope: implementation work from roughly 2026-03-01 onward

This timeline groups the recent implementation history into reusable retrospective topics.
...
Read these in order if you want the decision flow.

- The first two explain how scaffold quality and backend protocol constraints became the core technical issues.
- The middle two explain how the project established promotion rules and refactored itself into a safer structure.
- The last two explain how productization and frontend expansion became evidence-driven rather than heuristic-driven.
