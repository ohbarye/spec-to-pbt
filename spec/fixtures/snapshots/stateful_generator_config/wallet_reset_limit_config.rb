...
# Regeneration-safe customization file for wallet_reset_limit stateful scaffold.
...
WalletResetLimitPbtConfig = {
  ...
  command_mappings: {
    reset_to_limit: {
      method: :reset_to_limit, # TODO(required): replace with real method name
