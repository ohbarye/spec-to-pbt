...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| financial | `partial_refund_remaining_capturable.als` | stateful runtime setup | generated execution command | run with `RUBYOPT=-I/Users/ohbarye/ghq/github.com/ohbarye/pbt/lib` in this repo workspace | bundled `pbt` did not provide `Pbt.stateful`, so the scaffold failed before domain logic ran | `documentation_gap` | `job_status_event_counters` | `improve_comment_or_docs` | `improve_comment_or_docs` |
