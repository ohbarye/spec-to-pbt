...
InventoryProjectionPbtConfig = {
  ...
  verify_context: {
    state_reader: nil, # suggested: ->(sut) { { adjustments: sut.adjustments.dup, stock: sut.stock } }; configure this when observed-state checks should be compared against the model
  }
  # before_run: ->(sut) { },
